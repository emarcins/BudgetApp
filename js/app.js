class BudgetApp {
    ...
    addItem(){
        ...
        this.createItem(newItem.id, newItem.isPlus, newItem.description, newItem.value));
    ...
    getListElement(target) {
        ...
        // łapiemy li class="list__item", który złapaliśmy w funkcji listClickHandler poprzez atrybut data - dataset.camelCase atrybutu (dataset.editButton);
